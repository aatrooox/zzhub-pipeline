...
### Legacy Migration
The pipeline automatically reads legacy config from the old CLI directory if the primary config is missing or incomplete. Use `doctor` to see if a legacy config is being used.
